 ...
 *
 */
public class SimpleDaoClassPrinter {
    ...
    public SimpleDaoClassPrinter(Database db, String tableName) throws IOException, SQLException {
        this(db.selectTable(tableName, true));
    }

    public SimpleDaoClassPrinter(TableType table) throws IOException {
    ...
    protected String readContent(String name) throws IOException {
        try (InputStream is = SimpleDaoClassPrinter.class.getResourceAsStream(name)) {
